...
These two components are integrated as part of our implementation of the abstract modules PHP-Net and 3DPHP-Net, which realize the functions 、$\mathcal{F}_{PHP}$ and $F_{3DPHP}$ defined in our formulation.
